  ...
  const categories = [
    {
      ...
      courses: [
        ...
        { id: 'pathfinding', title: 'Pathfinding Algorithms', difficulty: 'Hard', timeToComplete: '6 hours', imageAlt: 'Pathfinding Illustration' },
          ...
          <div key={index} className="tw-mb-12">
            ...
            <div className="tw-grid tw-grid-cols-1 sm:tw-grid-cols-2 md:tw-grid-cols-3 lg:tw-grid-cols-4 tw-gap-4">
              {category.courses.map(course => (
                <Card key={course.id} maxWidth={24} radius="l-4" direction="column" onClick={() => window.location.href = `/learn/${course.id}/study-material`}>
